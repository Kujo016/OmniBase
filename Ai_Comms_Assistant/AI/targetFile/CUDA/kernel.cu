...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// CUDA Kernel 
__global__ void tag_python_lines(char* data, int size) {
...
void process_python_files(std::vector<std::string>& files) {
    ...
    for (auto& file : files) {
        ...
        tag_python_lines << <gridSize, blockSize >> > (d_data, fileSize);
